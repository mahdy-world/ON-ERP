...
urlpatterns = [
    ...
    path('items/edit/main_price/<int:pk>/', edit_invoice_item_main_price, name='edit_invoice_item_main_price'),
    ...
    path('add_product2/<int:pk>/', add_product_to_invoice2, name='add_product_to_invoice2'),
    ...
    path('edit/warehouse/<int:pk>/', edit_invoice_warehouse, name='edit_invoice_warehouse'),
    path('<int:invoice_id>/get_form_main_warehouse/', get_form_main_warehouse, name='get_form_main_warehouse'),
    path('<int:invoice_id>/get_form_sub_warehouse/', get_form_sub_warehouse, name='get_form_sub_warehouse'),
    path('<int:invoice_id>/get_form_all_warehouse/', get_form_all_warehouse, name='get_form_all_warehouse'),
    path('get_product_sell_comment/', get_product_sell_comment, name='get_product_sell_comment'),
    path('get_customer_sell_comment/', get_customer_sell_comment, name='get_customer_sell_comment'),
    path('edit/invoice_main_warehouse/<int:pk>/', edit_invoice_main_warehouse, name='edit_invoice_main_warehouse'),
    path('edit/invoice_sub_warehouse/<int:pk>/', edit_invoice_sub_warehouse, name='edit_invoice_sub_warehouse'),
    path('display_all_prods/', display_all_prods, name='display_all_prods'),
